...
export default function Navbar() {
  ...
  const navBg = useTransform(
    scrollY,
    [0, 60],
    ["rgba(255,253,245,0)", "rgba(255,253,245,0.96)"]
  );
  ...
  const navShadow = useTransform(
    scrollY,
    [0, 60],
    ["0px 0px 0px rgba(0,0,0,0)", "4px 0px 0px rgba(0,0,0,0)"]
  );
  ...
  return (
    <>
      ...
      >
        <motion.div
          style={{ borderBottomColor: navBorder, borderBottomWidth: scrolled ? "2px" : "0px" }}
